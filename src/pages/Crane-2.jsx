...
export const CraneSecond = () => {
  ...
  const [sValue, setSValue] = useState(option1[0].value);
  ...
  }, [mass, velocity, cycle, force, stroke, velocity2, mass2, tempMax, tempMin]);
      ...
      <div className="Crane2 inputFields">
        ...
        <div className="md:flex md:justify-between">
          ...
          <DynamicHeading
            ...
            initialContent="Crane/Wagon/Girder against Wagon"
            content={content}
